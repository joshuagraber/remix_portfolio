    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, db_server_1.prisma.postImage.findMany({
                            select: {
                                id: true,
                                altText: true,
                                createdAt: true,
                ...
                case 2:
                    ...
                    return [2 /*return*/, (0, node_1.json)({
                            images: images.map(function (image) { return (__assign(__assign({}, image), { url: (0, misc_tsx_1.getPostImageSource)(image.id) })); })
                        })];
            }
        });
    });
