...
function loader(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    host = (_b = request.headers.get('X-Forwarded-Host')) !== null && _b !== void 0 ? _b : request.headers.get('host');
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    ...
                    return [4 /*yield*/, Promise.all([
                            db_server_ts_1.prisma.user.count(),
                ...
                case 3:
                    error_1 = _c.sent();
                    console.log('healthcheck ❌', { error: error_1 });
