...
// Not used at the moment, needs to be edited if it's going to be used
function loader(_a) {
    var request = _a.request;
    return __awaiter(this, void 0, void 0, function () {
        var userId, user, domain;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    user = _b.sent();
                    domain = (0, misc_tsx_1.getDomainUrl)(request);
                    return [2 /*return*/, (0, node_1.json)({
                            user: __assign(__assign({}, user), { image: user.image
                                    ? __assign(__assign({}, user.image), { url: "".concat(domain, "/resources/user-images/").concat(user.image.id) }) : null })
                        })];
            }
        });
    });
