		...
		<>
			<ContainerCenter className='jdg-work-container-center'>
				<div className='jdg-work-about-container'>
					...
					<p>
						Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloremque minima tempore
						ipsum at nisi magnam error blanditiis, inventore architecto dolore ratione quidem?
						Dignissimos, necessitatibus labore. Impedit molestiae distinctio dolorum velit. Rerum
						sit soluta minima molestiae numquam magnam optio rem, sapiente dolorum. Maxime ipsam, in
						velit expedita asperiores, facere odio fugiat voluptatem reiciendis alias nesciunt
						commodi quas dolores nisi labore culpa! Id sint consectetur non rem a, reiciendis ab
						aliquam, deleniti maiores perspiciatis quaerat expedita velit totam, ullam recusandae
						incidunt fuga minima sed? Aliquid beatae eligendi quis laborum dignissimos harum
						aliquam!
					</p>
				</div>
