...
exports.useImageUploader = void 0;
var react_1 = require("@remix-run/react");
var DEFAULT_TIMEOUT = 1000 * 30; // 30-second timeout by default
/**
 * This is useful for creating an image upload handler for the MDX editor. It's not actually the best way of doing things.
 */
function useImageUploader(_a) {
    var _this = this;
    var _b = _a === void 0 ? {
        uploadTimeout: DEFAULT_TIMEOUT
    } : _a, uploadTimeout = _b.uploadTimeout;
    var imageFetcher = (0, react_1.useFetcher)();
    return function (file) { return __awaiter(_this, void 0, void 0, function () {
        var formData, uploadPromise, imageUrl, error_1;
