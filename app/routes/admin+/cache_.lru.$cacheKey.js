...
function loader(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, currentInstanceInfo, allInstances, instance, cacheKey;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    currentInstanceInfo = _c.sent();
                    return [4 /*yield*/, (0, litefs_server_ts_1.getAllInstances)()];
                case 3:
                    allInstances = _c.sent();
                    instance = (_b = searchParams.get('instance')) !== null && _b !== void 0 ? _b : currentInstanceInfo.currentInstance;
                    return [4 /*yield*/, (0, litefs_server_ts_1.ensureInstance)(instance)];
                case 4:
                    _c.sent();
                    cacheKey = params.cacheKey;
                    (0, invariant_1.invariantResponse)(cacheKey, 'cacheKey is required');
                    return [2 /*return*/, (0, node_1.json)({
                            ...
                            cacheKey: cacheKey,
                            value: cache_server_ts_1.lruCache.get(cacheKey)
                        })];
            }
        });
    });
