        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    verifySession.set(onboarding_tsx_1.onboardingEmailSessionKey, submission.value.target);
                    _b = node_1.redirect;
                    _c = ['/onboarding'];
                    _e = {};
                    _f = {};
                ...
                case 2: return [2 /*return*/, _b.apply(void 0, _c.concat([(_e.headers = (_f[_d] = _g.sent(),
                            _f),
                            _e)]))];
            }
        });
